...
with open('SRR3879605_1_bc.fastq') as c:
    for line in c:
...
w = csv.writer(open("SRR3879605_bc_dict.csv", "w"))
...
bc = csv.writer(open("whitelist_SRR3879605_bc.csv", "w"))
for key, val in sample_dict.items():
